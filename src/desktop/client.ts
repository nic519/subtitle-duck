...
export const desktopApi = {
  ...
  selectWhisperModelFile: () => electrobun?.rpc.request.selectWhisperModelFile() ?? unavailable("选择 whisper 模型"),
  selectFfmpegBinaryFile: () => electrobun?.rpc.request.selectFfmpegBinaryFile() ?? unavailable("选择 FFmpeg"),
  selectWhisperBinaryFile: () => electrobun?.rpc.request.selectWhisperBinaryFile() ?? unavailable("选择 whisper-cli"),
  ...
  selectWhisperCoreMlPackageFile: () => electrobun?.rpc.request.selectWhisperCoreMlPackageFile() ?? unavailable("选择 Core ML 加速包"),
  ...
  getWhisperCoreMlStatus: (modelPath?: string | null) => electrobun?.rpc.request.getWhisperCoreMlStatus({ modelPath }) ?? Promise.resolve({ available: false, expectedPath: null, installedPath: null, error: "仅桌面端支持" }),
  installWhisperCoreMlPackage: (input: { packagePath: string; modelPath?: string | null }) => electrobun?.rpc.request.installWhisperCoreMlPackage(input) ?? unavailable("安装 Core ML 加速包"),
  ...
  getWhisperStatus: () => electrobun?.rpc.request.getWhisperStatus() ?? Promise.resolve({ available: false, path: null, version: null, error: "仅桌面端支持" }),
  getSubtitleTranscriptionEngine: () => electrobun?.rpc.request.getSubtitleTranscriptionEngine() ?? Promise.resolve("whisper.cpp" as const),
